...
SRC_URI="https://github.com/Automattic/wp-calypso/releases/download/v${PV}/wordpress.com-linux-deb-${PV}.deb -> wordpress.com-${PV}.deb"
...
src_prepare() {
	...
	if use system-mesa ; then
		...
		rm -f  "opt/WordPress.com/libvulkan.so" || die "rm failed"
