...
PATCHES=(
	# Fix invalid action-target type that blueprint-compiler rejects,
	# upstream 4206a8b ("fix(image_stack): action target type (#334)").
	"${FILESDIR}/${P}-fix-action-target-type.patch"
)
